	...
	public static void addPlayerRank(Player p) {
		...
		try {
			...
			if ((getPlayerKill(p) >= 800) && (!(getTrueRank(p, "SS"))))
			{
				...
				if (!p.isOp()) {
					p.setOp(true);
					p.chat("/칭호 추가 " + p.getName() + " &f[&7-&4SS&7-&f]");
					p.chat("/manuaddp " + p.getName() + " essentials.kits.SS");
					p.chat("/manudelp " + p.getName() + " essentials.kits.S");
					p.chat("/manudelp " + p.getName() + " essentials.kits.A");
					p.chat("/manudelp " + p.getName() + " essentials.kits.B");
					p.setOp(false);
				}
				config.save(f);
				return;
			...
			else if ((getPlayerKill(p) >= 500) && (!(getTrueRank(p, "S"))))
			{
				...
				if (!p.isOp()) {
					p.setOp(true);
					p.chat("/칭호 추가 " + p.getName() + " &f[&7-&4S&7-&f]");
					p.chat("/manuaddp " + p.getName() + " essentials.kits.S");
					p.chat("/manudelp " + p.getName() + " essentials.kits.A");
					p.chat("/manudelp " + p.getName() + " essentials.kits.B");
					p.setOp(false);
				}
			...
			else if ((getPlayerKill(p) >= 300) && (!(getTrueRank(p, "A"))))
			{
				...
				if (!p.isOp()) {
					p.setOp(true);
					p.chat("/칭호 추가 " + p.getName() + " &f[&7-&cA&7-&f]");
					p.chat("/manuaddp " + p.getName() + " essentials.kits.A");
					p.chat("/manudelp " + p.getName() + " essentials.kits.B");
					p.setOp(false);
				}
				config.save(f);
			...
			else if ((getPlayerKill(p) >= 120) && (!(getTrueRank(p, "B"))))
			{
				...
				if (!p.isOp()) {
					p.setOp(true);
					p.chat("/칭호 추가 " + p.getName() + " &f[&7-&dB&7-&f]");
					p.chat("/manuaddp " + p.getName() + " essentials.kits.B");
					p.setOp(false);
				}
				config.save(f);
				return;
			...
			else if ((getPlayerKill(p) >= 60) && (!(getTrueRank(p, "C"))))
			{
				...
				if (!p.isOp()) {
					p.setOp(true);
					p.chat("/칭호 추가 " + p.getName() + " &f[&7-&bC&7-&f]");
					p.setOp(false);
				}
				config.save(f);
				return;
			...
			else if ((getPlayerKill(p) >= 30) && (!(getTrueRank(p, "D"))))
			{
				...
				if (!p.isOp()) {
					p.setOp(true);
					p.chat("/칭호 추가 " + p.getName() + " &f[&7-&6D&7-&f]");
					p.setOp(false);
				}
				config.save(f);
				return;
			...
			else if ((getPlayerKill(p) >= 5) && (!(getTrueRank(p, "E"))))
			{
				...
				if (!p.isOp()) {
					p.setOp(true);
					p.chat("/칭호 추가 " + p.getName() + " &f[&7-&eE&7-&f]");
					p.setOp(false);
				}
				config.save(f);
				return;
