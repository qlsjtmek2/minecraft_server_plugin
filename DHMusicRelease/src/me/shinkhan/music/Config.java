...
public class Config {
	public static void CreateConfig(File f, File folder, YamlConfiguration config)
	{
		try
		{
			...
			config.save(f);
			 ...
			 System.out.println("[DHMusicRelease] Exception Occured: " + ioex.getMessage());
			 System.out.println("========================");
	...
	public static List<String> getList(String name) {
		File f = new File("plugins/DHMusicRelease/config.yml");
		File folder = new File("plugins/DHMusicRelease");
