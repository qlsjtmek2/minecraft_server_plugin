...
/*    */ 
/*    */ public class CondIsLeftAndShiftClick extends Condition
/*    */ {
...
/* 29 */     return "is left click and shift click";
/*    */   }
/*    */ 
/*    */   public boolean check(Event arg0) {
/* 33 */     String clicktype = (String)this.clicktype.getSingle(arg0);
/*    */ 
/* 35 */     return (clicktype.contains("LeftClick")) && (clicktype.contains("ShiftClick"));
/*    */   }
/*    */ }

/* Location:           C:\Users\신희곤\Desktop\서버 버킷폴더\NEW 액션RPG Project\액션RPG\plugins\[스크립트]MarSK.jar
 * Qualified Name:     com.marquez.marsk.Conditions.CondIsLeftAndShiftClick
