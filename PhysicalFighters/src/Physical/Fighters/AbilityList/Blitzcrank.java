...
public class Blitzcrank extends AbilityBase
{
    public Blitzcrank() {
        if (PhysicalFighters.SRankUsed) {
            this.InitAbility("\ube14\ub9ac\uce20\ud06c\ub7ad\ud06c", Type.Active_Immediately, Rank.SS, "\ub208\ub369\uc774\ub97c \ub358\uc838, \ub9de\uc740 \uc801\uc744 \uc790\uc2e0\uc5d0\uac8c \ub04c\uc5b4\ub2f9\uae41\ub2c8\ub2e4.");
    ...
    public int A_Condition(final Event event, final int CustomData) {
        switch (CustomData) {
            case 0: {
                ...
                if (EventManager.DamageGuard || !(Event0.getDamager() instanceof Snowball)) {
                    break;
                }
    ...
    public void A_Effect(final Event event, final int CustomData) {
        switch (CustomData) {
            case 0: {
                ...
                final Location l2 = this.GetPlayer().getLocation();
                pe.teleport(l2);
                break;
            }
            case 1: {
                final PlayerDropItemEvent Event2 = (PlayerDropItemEvent)event;
                Event2.getPlayer().sendMessage(PhysicalFighters.a + "소유한 눈덩이가 §e16개 이하§f일시 못버립니다.");
                Event2.setCancelled(true);
                break;
            }
            case 2: {
                final PlayerRespawnEvent Event3 = (PlayerRespawnEvent)event;
                Event3.getPlayer().sendMessage(PhysicalFighters.a + "§a눈덩이§f가 지급됩니다.");
