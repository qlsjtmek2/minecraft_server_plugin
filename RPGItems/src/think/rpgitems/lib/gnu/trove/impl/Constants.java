...
package think.rpgitems.lib.gnu.trove.impl;
...
public class Constants
{
    ...
    static {
        VERBOSE = (System.getProperty("think.rpgitems.lib.gnu.trove.verbose", null) != null);
        String property = System.getProperty("think.rpgitems.lib.gnu.trove.no_entry.byte", "0");
        byte value;
        ...
        property = System.getProperty("think.rpgitems.lib.gnu.trove.no_entry.short", "0");
        short value2;
        if ("MAX_VALUE".equalsIgnoreCase(property)) {
            value2 = 32767;
        }
        ...
        property = System.getProperty("think.rpgitems.lib.gnu.trove.no_entry.char", "\u0000");
        char value3;
        if ("MAX_VALUE".equalsIgnoreCase(property)) {
            value3 = '\uffff';
        }
        ...
        property = System.getProperty("think.rpgitems.lib.gnu.trove.no_entry.int", "0");
        int value4;
        if ("MAX_VALUE".equalsIgnoreCase(property)) {
        ...
        String property2 = System.getProperty("think.rpgitems.lib.gnu.trove.no_entry.long", "0");
        long value5;
        ...
        property = System.getProperty("think.rpgitems.lib.gnu.trove.no_entry.float", "0");
        float value6;
        if ("MAX_VALUE".equalsIgnoreCase(property)) {
        ...
        property2 = System.getProperty("think.rpgitems.lib.gnu.trove.no_entry.double", "0");
        double value7;
        if ("MAX_VALUE".equalsIgnoreCase(property2)) {
