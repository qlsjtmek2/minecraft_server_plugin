...
public class ATwalkview implements CommandExecutor
{
	private AutomaticTriggers plugin;

	public ATwalkview(AutomaticTriggers plugin)
	{
		this.plugin = plugin;
	}
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args)
	{
		if(sender.hasPermission("atriggers.admin") || sender.isOp() == true)
		{
			...
			if (args.length == 0)
			{
				plugin.listener.setListener(sender.getName(), "", "", 0, "walkview", true);
