...
public class main extends JavaPlugin implements Listener {
	public static final String INVENTORY_NAME = ChatColor.BLACK + "교환";
	...
	public void onEnable() {
		...
		getCommand("거래").setExecutor(new mainCommand(this));
		getCommand("교환").setExecutor(new mainCommand(this));
