...
public class WorldGenMinable extends WorldGenerator
{
    ...
    public WorldGenMinable(final int n, final int n2) {
        this(n, n2, Block.STONE.id);
    }
    
    public WorldGenMinable(final int a, final int b, final int c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
                    ...
                    for (int k = floor2; k <= floor5; ++k) {
                        ...
                        if (n17 * n17 + n18 * n18 < 1.0) {
                            for (int l = floor3; l <= floor6; ++l) {
                                ...
                                if (n17 * n17 + n18 * n18 + n19 * n19 < 1.0 && world.getTypeId(j, k, l) == this.c) {
