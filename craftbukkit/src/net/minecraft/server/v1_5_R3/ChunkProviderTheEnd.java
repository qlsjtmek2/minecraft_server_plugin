...
public class ChunkProviderTheEnd implements IChunkProvider
{
    ...
    public void b(final int n, final int n2, final byte[] array, final BiomeBase[] array2) {
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                final int n3 = 1;
                int n4 = -1;
                byte b = (byte)Block.WHITESTONE.id;
    ...
    public Chunk getOrCreateChunk(final int i, final int j) {
        ...
        this.a(i, j, abyte, this.o = this.m.getWorldChunkManager().getBiomeBlock(this.o, i * 16, j * 16, 16, 16));
        this.b(i, j, abyte, this.o);
        final Chunk chunk = new Chunk(this.m, abyte, i, j);
    ...
    public void getChunkAt(final IChunkProvider chunkProvider, final int n, final int n2) {
        ...
        final int n3 = n * 16;
        final int n4 = n2 * 16;
        this.m.getBiome(n3 + 16, n4 + 16).a(this.m, this.m.random, n3, n4);
    ...
    public List getMobsFor(final EnumCreatureType enumCreatureType, final int i, final int n, final int j) {
        final BiomeBase biome = this.m.getBiome(i, j);
        if (biome == null) {
            return null;
        }
