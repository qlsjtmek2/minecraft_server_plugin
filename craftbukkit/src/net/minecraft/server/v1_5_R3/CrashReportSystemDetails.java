...
public class CrashReportSystemDetails
{
    ...
    public static void a(final CrashReportSystemDetails crashReportSystemDetails, final int n, final int n2, final int n3, final int n4, final int n5) {
        crashReportSystemDetails.a("Block type", new CrashReportBlockType(n4));
        crashReportSystemDetails.a("Block data value", new CrashReportBlockDataValue(n5));
