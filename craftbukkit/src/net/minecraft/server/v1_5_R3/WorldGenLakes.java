...
public class WorldGenLakes extends WorldGenerator
{
    ...
    public WorldGenLakes(final int a) {
        this.a = a;
    }
            ...
            for (int n15 = 0; n15 < 16; ++n15) {
                for (int n16 = 0; n16 < 8; ++n16) {
                    if (!array[(n14 * 16 + n15) * 8 + n16] && ((n14 < 15 && array[((n14 + 1) * 16 + n15) * 8 + n16]) || (n14 > 0 && array[((n14 - 1) * 16 + n15) * 8 + n16]) || (n15 < 15 && array[(n14 * 16 + (n15 + 1)) * 8 + n16]) || (n15 > 0 && array[(n14 * 16 + (n15 - 1)) * 8 + n16]) || (n16 < 7 && array[(n14 * 16 + n15) * 8 + (n16 + 1)]) || (n16 > 0 && array[(n14 * 16 + n15) * 8 + (n16 - 1)]))) {
                        final Material material = world.getMaterial(i + n14, j + n16, k + n15);
                        if (n16 >= 4 && material.isLiquid()) {
                            return false;
                        }
                        if (n16 < 4 && !material.isBuildable() && world.getTypeId(i + n14, j + n16, k + n15) != this.a) {
                            return false;
                        }
                    }
                }
            ...
            for (int n18 = 0; n18 < 16; ++n18) {
                for (int n19 = 0; n19 < 8; ++n19) {
                    if (array[(n17 * 16 + n18) * 8 + n19]) {
                        world.setTypeIdAndData(i + n17, j + n19, k + n18, (n19 >= 4) ? 0 : this.a, 0, 2);
                    }
                }
            }
        }
        for (int n20 = 0; n20 < 16; ++n20) {
            for (int n21 = 0; n21 < 16; ++n21) {
                for (int n22 = 4; n22 < 8; ++n22) {
                    if (array[(n20 * 16 + n21) * 8 + n22] && world.getTypeId(i + n20, j + n22 - 1, k + n21) == Block.DIRT.id && world.b(EnumSkyBlock.SKY, i + n20, j + n22, k + n21) > 0) {
                        if (world.getBiome(i + n20, k + n21).A == Block.MYCEL.id) {
                            world.setTypeIdAndData(i + n20, j + n22 - 1, k + n21, Block.MYCEL.id, 0, 2);
                        }
                        else {
                            world.setTypeIdAndData(i + n20, j + n22 - 1, k + n21, Block.GRASS.id, 0, 2);
                        }
                    }
                }
            }
            ...
            for (int n23 = 0; n23 < 16; ++n23) {
                for (int n24 = 0; n24 < 16; ++n24) {
                    for (int n25 = 0; n25 < 8; ++n25) {
                        if (!array[(n23 * 16 + n24) * 8 + n25] && ((n23 < 15 && array[((n23 + 1) * 16 + n24) * 8 + n25]) || (n23 > 0 && array[((n23 - 1) * 16 + n24) * 8 + n25]) || (n24 < 15 && array[(n23 * 16 + (n24 + 1)) * 8 + n25]) || (n24 > 0 && array[(n23 * 16 + (n24 - 1)) * 8 + n25]) || (n25 < 7 && array[(n23 * 16 + n24) * 8 + (n25 + 1)]) || (n25 > 0 && array[(n23 * 16 + n24) * 8 + (n25 - 1)])) && (n25 < 4 || random.nextInt(2) != 0) && world.getMaterial(i + n23, j + n25, k + n24).isBuildable()) {
                            world.setTypeIdAndData(i + n23, j + n25, k + n24, Block.STONE.id, 0, 2);
                        }
                    }
                }
            }
        ...
        if (Block.byId[this.a].material == Material.WATER) {
            for (int n26 = 0; n26 < 16; ++n26) {
                for (int n27 = 0; n27 < 16; ++n27) {
                    final int n28 = 4;
                    if (world.x(i + n26, j + n28, k + n27)) {
                        world.setTypeIdAndData(i + n26, j + n28, k + n27, Block.ICE.id, 0, 2);
                    }
                }
            }
        }
