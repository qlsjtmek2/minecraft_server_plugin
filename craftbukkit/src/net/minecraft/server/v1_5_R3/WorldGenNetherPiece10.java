...
{
    public WorldGenNetherPiece10(final int n, final Random random, final StructureBoundingBox e, final int f) {
        super(n);
        this.f = f;
        this.e = e;
    }
    ...
    public static WorldGenNetherPiece10 a(final List list, final Random random, final int n, final int n2, final int n3, final int n4, final int n5) {
        ...
        return new WorldGenNetherPiece10(n5, random, a, n4);
    }
