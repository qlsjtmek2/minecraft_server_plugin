...
final class DispenseBehaviorFireworks extends DispenseBehaviorItem
{
    public ItemStack b(final ISourceBlock isourceblock, final ItemStack itemstack) {
        ...
        final EntityFireworks entityfireworks = new EntityFireworks(isourceblock.k(), event.getVelocity().getX(), event.getVelocity().getY(), event.getVelocity().getZ(), itemstack2);
