...
public class WorldGenFlatInfo
{
    ...
    private static WorldGenFlatLayerInfo a(final String s, final int n) {
        ...
        final WorldGenFlatLayerInfo worldGenFlatLayerInfo = new WorldGenFlatLayerInfo(int1, int3, int2);
        worldGenFlatLayerInfo.d(n);
    ...
    public static WorldGenFlatInfo a(final String s) {
        ...
        worldGenFlatInfo.d();
        int n3 = BiomeBase.PLAINS.id;
        if (n > 0 && split.length > n2) {
            n3 = MathHelper.a(split[n2++], n3);
        }
        worldGenFlatInfo.a(n3);
        if (n > 0 && split.length > n2) {
