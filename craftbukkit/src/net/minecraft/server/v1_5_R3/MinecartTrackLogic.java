...
public class MinecartTrackLogic
{
    ...
    public MinecartTrackLogic(final BlockMinecartTrackAbstract a, final World b, final int i, final int j, final int k) {
        ...
        this.d = j;
        this.e = k;
        final int typeId = b.getTypeId(i, j, k);
        int data = b.getData(i, j, k);
        if (((BlockMinecartTrackAbstract)Block.byId[typeId]).a) {
            this.f = true;
            data &= 0xFFFFFFF7;
        }
        else {
    ...
    private boolean a(final int n, final int n2, final int n3) {
        return BlockMinecartTrackAbstract.d_(this.b, n, n2, n3) || BlockMinecartTrackAbstract.d_(this.b, n, n2 + 1, n3) || BlockMinecartTrackAbstract.d_(this.b, n, n2 - 1, n3);
    }
    
    private MinecartTrackLogic a(final ChunkPosition chunkPosition) {
        if (BlockMinecartTrackAbstract.d_(this.b, chunkPosition.x, chunkPosition.y, chunkPosition.z)) {
            return new MinecartTrackLogic(this.a, this.b, chunkPosition.x, chunkPosition.y, chunkPosition.z);
        }
        if (BlockMinecartTrackAbstract.d_(this.b, chunkPosition.x, chunkPosition.y + 1, chunkPosition.z)) {
