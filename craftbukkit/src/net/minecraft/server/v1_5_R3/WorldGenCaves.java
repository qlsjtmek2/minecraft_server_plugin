...
{
    protected void a(final long n, final int n2, final int n3, final byte[] array, final double n4, final double n5, final double n6) {
        this.a(n, n2, n3, array, n4, n5, n6, 1.0f + this.b.nextFloat() * 6.0f, 0.0f, 0.0f, -1, -1, 0.5);
    }
    
    protected void a(final long n, final int n2, final int n3, final byte[] array, double n4, double n5, double n6, final float n7, float n8, float n9, int i, int n10, final double n11) {
                        ...
                        for (int n33 = n26; n32 == 0 && n33 < n27; ++n33) {
                            for (int n34 = n30; n32 == 0 && n34 < n31; ++n34) {
                                for (int n35 = n29 + 1; n32 == 0 && n35 >= n28 - 1; --n35) {
                                    ...
                                    if (n35 >= 0) {
                                        if (n35 < 128) {
                                            if (array[n36] == Block.WATER.id || array[n36] == Block.STATIONARY_WATER.id) {
                                                n32 = 1;
                                            }
                                    ...
                                    if (n37 * n37 + n38 * n38 < 1.0) {
                                        for (int l = n29 - 1; l >= n28; --l) {
                                            ...
                                            if (n40 > -0.7 && n37 * n37 + n40 * n40 + n38 * n38 < 1.0) {
                                                final byte b4 = array[n39];
                                                if (b4 == Block.GRASS.id) {
                                                    b3 = true;
                                                }
                                                if (b4 == Block.STONE.id || b4 == Block.DIRT.id || b4 == Block.GRASS.id) {
                                                    if (l < 10) {
                                                        array[n39] = (byte)Block.LAVA.id;
                                                    }
                                                    else {
                                                        array[n39] = 0;
                                                        if (b3 && array[n39 - 1] == Block.DIRT.id) {
                                                            array[n39 - 1] = this.c.getBiome(j + n2 * 16, k + n3 * 16).A;
                                                        }
                                                    }
                                                }
                                            }
    ...
    protected void a(final World world, final int n, final int n2, final int n3, final int n4, final byte[] array) {
        int nextInt = this.b.nextInt(this.b.nextInt(this.b.nextInt(40) + 1) + 1);
