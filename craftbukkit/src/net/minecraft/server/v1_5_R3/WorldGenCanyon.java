                        ...
                        for (int n35 = n28; n34 == 0 && n35 < n29; ++n35) {
                            for (int n36 = n32; n34 == 0 && n36 < n33; ++n36) {
                                for (int n37 = n31 + 1; n34 == 0 && n37 >= n30 - 1; --n37) {
                                    final int n38 = (n35 * 16 + n36) * 128 + n37;
                                    if (n37 >= 0) {
                                        if (n37 < 128) {
                                            if (array[n38] == Block.WATER.id || array[n38] == Block.STATIONARY_WATER.id) {
                                                n34 = 1;
                                            }
                                    ...
                                    if (n39 * n39 + n40 * n40 < 1.0) {
                                        for (int n42 = n31 - 1; n42 >= n30; --n42) {
                                            ...
                                            if ((n39 * n39 + n40 * n40) * this.d[n42] + n43 * n43 / 6.0 < 1.0) {
                                                final byte b3 = array[n41];
                                                if (b3 == Block.GRASS.id) {
                                                    b2 = true;
                                                }
                                                if (b3 == Block.STONE.id || b3 == Block.DIRT.id || b3 == Block.GRASS.id) {
                                                    if (n42 < 10) {
                                                        array[n41] = (byte)Block.LAVA.id;
                                                    }
                                                    else {
                                                        array[n41] = 0;
                                                        if (b2 && array[n41 - 1] == Block.DIRT.id) {
                                                            array[n41 - 1] = this.c.getBiome(k + n2 * 16, l + n3 * 16).A;
                                                        }
                                                    }
                                                }
                                            }
