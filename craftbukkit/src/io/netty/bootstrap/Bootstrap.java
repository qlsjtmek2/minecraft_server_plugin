...
public final class Bootstrap extends AbstractBootstrap<Bootstrap, Channel>
{
    ...
    private ChannelFuture doConnect(final SocketAddress remoteAddress, final SocketAddress localAddress) {
        ...
        if (regFuture.isDone()) {
            ...
            regFuture.addListener((GenericFutureListener<? extends Future<Void>>)new ChannelFutureListener() {
                @Override
        ...
        channel.eventLoop().execute(new Runnable() {
            ...
            public void run() {
                if (regFuture.isSuccess()) {
                    ...
                    promise.addListener((GenericFutureListener<? extends Future<Void>>)ChannelFutureListener.CLOSE_ON_FAILURE);
                }
                else {
