...
public abstract class AbstractByteBuf implements ByteBuf
{
    ...
    public ByteBuf clear() {
        ...
        this.writerIndex = (b ? 1 : 0);
        this.readerIndex = (b ? 1 : 0);
        return this;
    }
    ...
    protected void adjustMarkers(final int decrement) {
    ...
    @Deprecated
    @Override
    public final ByteBuf ensureWritableBytes(final int minWritableBytes) {
        return this.ensureWritable(minWritableBytes);
    }
    ...
    public boolean equals(final Object o) {
        return this == o || (o instanceof ByteBuf && BufUtil.equals(this, (ByteBuf)o));
    }
