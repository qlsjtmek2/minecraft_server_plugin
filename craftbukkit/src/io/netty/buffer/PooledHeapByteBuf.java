...
{
    PooledHeapByteBuf(final int maxCapacity) {
        super(maxCapacity);
    }
    ...
    protected long _getLong(int index) {
        index = this.idx(index);
        return (((byte[])(Object)this.memory)[index] & 0xFFL) << 56 | (((byte[])(Object)this.memory)[index + 1] & 0xFFL) << 48 | (((byte[])(Object)this.memory)[index + 2] & 0xFFL) << 40 | (((byte[])(Object)this.memory)[index + 3] & 0xFFL) << 32 | (((byte[])(Object)this.memory)[index + 4] & 0xFFL) << 24 | (((byte[])(Object)this.memory)[index + 5] & 0xFFL) << 16 | (((byte[])(Object)this.memory)[index + 6] & 0xFFL) << 8 | (((byte[])(Object)this.memory)[index + 7] & 0xFFL);
    }
