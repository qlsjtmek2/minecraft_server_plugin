...
final class PooledUnsafeDirectByteBuf extends PooledByteBuf<ByteBuffer>
{
    ...
    PooledUnsafeDirectByteBuf(final int maxCapacity) {
        super(maxCapacity);
    }
    ...
    public ByteBuf copy(final int index, final int length) {
        this.checkIndex(index, length);
        final PooledUnsafeDirectByteBuf copy = (PooledUnsafeDirectByteBuf)this.alloc().directBuffer(length, this.maxCapacity());
        if (length != 0) {
