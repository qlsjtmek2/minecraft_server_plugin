...
public final class SwappedByteBuf implements ByteBuf
{
    ...
    @Deprecated
    @Override
    public ByteBuf ensureWritableBytes(final int minWritableBytes) {
    ...
    public short getShort(final int index) {
        return BufUtil.swapShort(this.buf.getShort(index));
    }
    ...
    public int getMedium(final int index) {
        return BufUtil.swapMedium(this.buf.getMedium(index));
    }
    ...
    public int getInt(final int index) {
        return BufUtil.swapInt(this.buf.getInt(index));
    }
    ...
    public long getLong(final int index) {
        return BufUtil.swapLong(this.buf.getLong(index));
    }
    ...
    public ByteBuf setShort(final int index, final int value) {
        this.buf.setShort(index, BufUtil.swapShort((short)value));
        return this;
    }
    
    @Override
    public ByteBuf setMedium(final int index, final int value) {
        this.buf.setMedium(index, BufUtil.swapMedium(value));
        return this;
    }
    
    @Override
    public ByteBuf setInt(final int index, final int value) {
        this.buf.setInt(index, BufUtil.swapInt(value));
        return this;
    }
    
    @Override
    public ByteBuf setLong(final int index, final long value) {
        this.buf.setLong(index, BufUtil.swapLong(value));
        return this;
    }
    ...
    public short readShort() {
        return BufUtil.swapShort(this.buf.readShort());
    }
    ...
    public int readMedium() {
        return BufUtil.swapMedium(this.buf.readMedium());
    }
    ...
    @Override
    public int readInt() {
        return BufUtil.swapInt(this.buf.readInt());
    }
    ...
    public long readLong() {
        return BufUtil.swapLong(this.buf.readLong());
    }
    ...
    public ByteBuf writeShort(final int value) {
        this.buf.writeShort(BufUtil.swapShort((short)value));
        return this;
    }
    
    @Override
    public ByteBuf writeMedium(final int value) {
        this.buf.writeMedium(BufUtil.swapMedium(value));
        return this;
    }
    
    @Override
    public ByteBuf writeInt(final int value) {
        this.buf.writeInt(BufUtil.swapInt(value));
        return this;
    }
    
    @Override
    public ByteBuf writeLong(final long value) {
        this.buf.writeLong(BufUtil.swapLong(value));
        return this;
    }
    ...
    public int indexOf(final int fromIndex, final int toIndex, final ByteBufIndexFinder indexFinder) {
        return this.buf.indexOf(fromIndex, toIndex, indexFinder);
    }
    ...
    public int bytesBefore(final ByteBufIndexFinder indexFinder) {
        return this.buf.bytesBefore(indexFinder);
    }
    ...
    public int bytesBefore(final int length, final ByteBufIndexFinder indexFinder) {
        return this.buf.bytesBefore(length, indexFinder);
    }
    ...
    public int bytesBefore(final int index, final int length, final ByteBufIndexFinder indexFinder) {
        return this.buf.bytesBefore(index, length, indexFinder);
    }
    ...
    public ByteBuf suspendIntermediaryDeallocations() {
        this.buf.suspendIntermediaryDeallocations();
        return this;
    }
    
    @Override
    public ByteBuf resumeIntermediaryDeallocations() {
        this.buf.resumeIntermediaryDeallocations();
        return this;
    }
    ...
    public boolean equals(final Object obj) {
        return this == obj || (obj instanceof ByteBuf && BufUtil.equals(this, (ByteBuf)obj));
    }
