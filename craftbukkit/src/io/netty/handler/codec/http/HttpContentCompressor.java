...
public class HttpContentCompressor extends HttpContentEncoder
{
    ...
    @Override
    protected Result beginEncode(final HttpMessage header, final HttpContent msg, final String acceptEncoding) throws Exception {
        final String contentEncoding = header.headers().get("Content-Encoding");
        ...
        return new Result(targetContentEncoding, new EmbeddedByteChannel(new ChannelHandler[] { ZlibCodecFactory.newZlibEncoder(wrapper, this.compressionLevel, this.windowBits, this.memLevel) }));
    }
