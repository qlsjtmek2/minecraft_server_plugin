...
public abstract class WebSocketClientHandshaker
{
    ...
    public final ChannelFuture handshake(final Channel channel, final ChannelPromise promise) {
        ...
        channel.write(request).addListener((GenericFutureListener<? extends Future<Void>>)new ChannelFutureListener() {
            @Override
    ...
    public final void finishHandshake(final Channel channel, final FullHttpResponse response) {
        ...
        if (ctx == null) {
            ...
            p.replaceAndForward(ctx.name(), "ws-decoder", this.newWebsocketDecoder());
        }
        else {
