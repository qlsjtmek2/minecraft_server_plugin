...
public class ProtobufDecoder extends MessageToMessageDecoder<ByteBuf>
{
    ...
    protected Object decode(final ChannelHandlerContext ctx, final ByteBuf msg) throws Exception {
        ...
        if (this.extensionRegistry == null) {
            ...
            if (ProtobufDecoder.HAS_PARSER) {
                return this.prototype.getParserForType().parseFrom(array, offset, length, (ExtensionRegistryLite)this.extensionRegistry);
            }
            return this.prototype.newBuilderForType().mergeFrom(array, offset, length, (ExtensionRegistryLite)this.extensionRegistry).build();
        }
    }
