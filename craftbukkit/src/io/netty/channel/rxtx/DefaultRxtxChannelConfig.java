...
final class DefaultRxtxChannelConfig extends DefaultChannelConfig implements RxtxChannelConfig
{
    ...
    public DefaultRxtxChannelConfig(final RxtxChannel channel) {
        super(channel);
    ...
    @Override
    public RxtxChannelConfig setDefaultHandlerByteBufType(final ChannelConfig.ChannelHandlerByteBufType type) {
