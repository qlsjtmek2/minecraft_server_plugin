...
public interface ChannelPipeline extends ChannelInboundInvoker, ChannelOutboundInvoker, Iterable<Map.Entry<String, ChannelHandler>>
{
    ...
    ChannelPipeline removeAndForward(final ChannelHandler p0);
    
    ChannelHandler remove(final String p0);
    
    ChannelHandler removeAndForward(final String p0);
    
     <T extends ChannelHandler> T remove(final Class<T> p0);
    
     <T extends ChannelHandler> T removeAndForward(final Class<T> p0);
    ...
    ChannelPipeline replaceAndForward(final ChannelHandler p0, final String p1, final ChannelHandler p2);
    
    ChannelHandler replace(final String p0, final String p1, final ChannelHandler p2);
    
    ChannelHandler replaceAndForward(final String p0, final String p1, final ChannelHandler p2);
    
     <T extends ChannelHandler> T replace(final Class<T> p0, final String p1, final ChannelHandler p2);
    
     <T extends ChannelHandler> T replaceAndForward(final Class<T> p0, final String p1, final ChannelHandler p2);
