...
public final class SctpNotificationHandler extends AbstractNotificationHandler<Object>
{
    ...
    private void fireEvent(final Notification notification, final Object o) {
        this.sctpChannel.pipeline().fireUserEventTriggered((Object)new SctpNotificationEvent(notification, o));
    }
}
