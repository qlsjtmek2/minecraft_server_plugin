...
final class DefaultChannelGroupFuture extends DefaultPromise<Void> implements ChannelGroupFuture
{
    ...
    public DefaultChannelGroupFuture(final ChannelGroup group, final Collection<ChannelFuture> futures, final EventExecutor executor) {
        super(executor);
            ...
            public void operationComplete(final ChannelFuture future) throws Exception {
                ...
                if (callSetDone) {
                    if (DefaultChannelGroupFuture.this.failureCount > 0) {
                        final List<Map.Entry<Integer, Throwable>> failed = new ArrayList<Map.Entry<Integer, Throwable>>(DefaultChannelGroupFuture.this.failureCount);
        ...
        for (final ChannelFuture f : this.futures.values()) {
            f.addListener((GenericFutureListener<? extends Future<Void>>)this.childListener);
        }
    ...
    DefaultChannelGroupFuture(final ChannelGroup group, final Map<Integer, ChannelFuture> futures, final EventExecutor executor) {
        super(executor);
        this.childListener = new ChannelFutureListener() {
            @Override
            public void operationComplete(final ChannelFuture future) throws Exception {
    ...
    @Override
    public DefaultChannelGroupFuture addListener(final GenericFutureListener<? extends Future<Void>> listener) {
        super.addListener(listener);
        return this;
    }
    
    @Override
    public DefaultChannelGroupFuture addListeners(final GenericFutureListener<? extends Future<Void>>... listeners) {
        super.addListeners(listeners);
        return this;
    }
    
    @Override
    public DefaultChannelGroupFuture removeListener(final GenericFutureListener<? extends Future<Void>> listener) {
        super.removeListener(listener);
        return this;
    }
    
    @Override
    public DefaultChannelGroupFuture removeListeners(final GenericFutureListener<? extends Future<Void>>... listeners) {
