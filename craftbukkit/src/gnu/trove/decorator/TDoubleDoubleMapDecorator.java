...
public class TDoubleDoubleMapDecorator extends AbstractMap<Double, Double> implements Map<Double, Double>, Externalizable, Cloneable
{
    ...
    public TDoubleDoubleMapDecorator(final TDoubleDoubleMap map) {
        this._map = map;
    }
    ...
    public Set<Entry<Double, Double>> entrySet() {
        return new AbstractSet<Entry<Double, Double>>() {
            ...
            public boolean add(final Entry<Double, Double> o) {
            ...
            public boolean addAll(final Collection<? extends Entry<Double, Double>> c) {
                throw new UnsupportedOperationException();
            }
    ...
    public void putAll(final Map<? extends Double, ? extends Double> map) {
        final Iterator<? extends Entry<? extends Double, ? extends Double>> it = map.entrySet().iterator();
        int i = map.size();
        while (i-- > 0) {
            final Entry<? extends Double, ? extends Double> e = (Entry<? extends Double, ? extends Double>)it.next();
