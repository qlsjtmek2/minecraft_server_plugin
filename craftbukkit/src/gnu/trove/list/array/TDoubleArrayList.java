...
public class TDoubleArrayList implements TDoubleList, Externalizable
{
    ...
    public TDoubleArrayList(final int capacity) {
        this(capacity, 0.0);
    }
    
    public TDoubleArrayList(final int capacity, final double no_entry_value) {
        this._data = new double[capacity];
        this._pos = 0;
        this.no_entry_value = no_entry_value;
    }
    
    public TDoubleArrayList(final TDoubleCollection collection) {
        this(collection.size());
        this.addAll(collection);
    }
    
    public TDoubleArrayList(final double[] values) {
        this(values.length);
        this.add(values);
    }
    
    protected TDoubleArrayList(final double[] values, final double no_entry_value, final boolean wrap) {
        if (!wrap) {
    ...
    public static TDoubleArrayList wrap(final double[] values) {
        return wrap(values, 0.0);
    }
    
    public static TDoubleArrayList wrap(final double[] values, final double no_entry_value) {
    ...
    public void trimToSize() {
        if (this._data.length > this.size()) {
            final double[] tmp = new double[this.size()];
    ...
    public double getQuick(final int offset) {
        return this._data[offset];
    }
    ...
    public double set(final int offset, final double val) {
        ...
        final double prev_val = this._data[offset];
    ...
    public double replace(final int offset, final double val) {
        ...
        final double old = this._data[offset];
        this._data[offset] = val;
        return old;
    }
    ...
    public void setQuick(final int offset, final double val) {
        this._data[offset] = val;
    }
    ...
    public double removeAt(final int offset) {
        final double old = this.get(offset);
    ...
    public TDoubleList subList(final int begin, final int end) {
        ...
        final TDoubleArrayList list = new TDoubleArrayList(end - begin);
    ...
    public boolean equals(final Object other) {
        ...
        final TDoubleArrayList that = (TDoubleArrayList)other;
    ...
    public int binarySearch(final double value, final int fromIndex, final int toIndex) {
        ...
        while (low <= high) {
            ...
            final double midVal = this._data[mid];
            if (midVal < value) {
                low = mid + 1;
            }
            else {
    ...
    class TDoubleArrayIterator implements TDoubleIterator
    {
        ...
        TDoubleArrayIterator(final int index) {
            this.cursor = 0;
            this.lastRet = -1;
            this.cursor = index;
        }
        ...
        public double next() {
            try {
                final double next = TDoubleArrayList.this.get(this.cursor);
