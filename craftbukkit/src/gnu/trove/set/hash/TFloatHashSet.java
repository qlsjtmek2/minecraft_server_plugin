...
public class TFloatHashSet extends TFloatHash implements TFloatSet, Externalizable
{
    ...
    public TFloatHashSet(final int initialCapacity) {
        super(initialCapacity);
    }
    
    public TFloatHashSet(final int initialCapacity, final float load_factor) {
        super(initialCapacity, load_factor);
    }
    
    public TFloatHashSet(final int initial_capacity, final float load_factor, final float no_entry_value) {
    ...
    public TFloatHashSet(final Collection<? extends Float> collection) {
        this(Math.max(collection.size(), 10));
        this.addAll(collection);
    }
    
    public TFloatHashSet(final TFloatCollection collection) {
        this(Math.max(collection.size(), 10));
        if (collection instanceof TFloatHashSet) {
            final TFloatHashSet hashset = (TFloatHashSet)collection;
    ...
    public TFloatHashSet(final float[] array) {
    ...
    public boolean remove(final float val) {
