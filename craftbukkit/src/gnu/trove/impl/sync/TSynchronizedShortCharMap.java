...
public class TSynchronizedShortCharMap implements TShortCharMap, Serializable
{
    ...
    public TSynchronizedShortCharMap(final TShortCharMap m) {
        this.keySet = null;
        this.values = null;
        if (m == null) {
    ...
    public TSynchronizedShortCharMap(final TShortCharMap m, final Object mutex) {
        this.keySet = null;
        this.values = null;
        this.m = m;
        this.mutex = mutex;
    ...
    public void putAll(final TShortCharMap map) {
        synchronized (this.mutex) {
            this.m.putAll(map);
        }
    }
