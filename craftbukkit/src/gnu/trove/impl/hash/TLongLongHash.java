...
public abstract class TLongLongHash extends TPrimitiveHash
{
    ...
    public TLongLongHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0L;
        this.no_entry_value = 0L;
    }
    
    public TLongLongHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0L;
        this.no_entry_value = 0L;
    }
    
    public TLongLongHash(final int initialCapacity, final float loadFactor, final long no_entry_key, final long no_entry_value) {
        super(initialCapacity, loadFactor);
