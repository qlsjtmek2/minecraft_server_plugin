...
public abstract class TShortIntHash extends TPrimitiveHash
{
    ...
    public TShortIntHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TShortIntHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TShortIntHash(final int initialCapacity, final float loadFactor, final short no_entry_key, final int no_entry_value) {
        super(initialCapacity, loadFactor);
