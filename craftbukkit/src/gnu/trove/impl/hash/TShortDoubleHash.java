...
public abstract class TShortDoubleHash extends TPrimitiveHash
{
    ...
    public TShortDoubleHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = 0.0;
    }
    
    public TShortDoubleHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = 0.0;
    }
    
    public TShortDoubleHash(final int initialCapacity, final float loadFactor, final short no_entry_key, final double no_entry_value) {
        super(initialCapacity, loadFactor);
    ...
    protected int index(final short key) {
        final byte[] states = this._states;
        final short[] set = this._set;
    ...
    protected int XinsertKey(final short key) {
        final byte[] states = this._states;
        final short[] set = this._set;
        final int length = states.length;
        final int hash = HashFunctions.hash(key) & Integer.MAX_VALUE;
