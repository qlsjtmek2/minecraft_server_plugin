...
public abstract class TFloatHash extends TPrimitiveHash
{
    ...
    public TFloatHash(final int initialCapacity) {
    ...
    public TFloatHash(final int initialCapacity, final float loadFactor) {
    ...
    public TFloatHash(final int initialCapacity, final float loadFactor, final float no_entry_value) {
        super(initialCapacity, loadFactor);
    ...
    protected int index(final float val) {
        final byte[] states = this._states;
        final float[] set = this._set;
