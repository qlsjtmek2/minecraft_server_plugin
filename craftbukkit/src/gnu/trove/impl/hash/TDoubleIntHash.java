...
public abstract class TDoubleIntHash extends TPrimitiveHash
{
    ...
    public TDoubleIntHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0;
        this.no_entry_value = 0;
    }
    
    public TDoubleIntHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0;
        this.no_entry_value = 0;
    }
    
    public TDoubleIntHash(final int initialCapacity, final float loadFactor, final double no_entry_key, final int no_entry_value) {
        super(initialCapacity, loadFactor);
