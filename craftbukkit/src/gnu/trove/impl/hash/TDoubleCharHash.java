...
public abstract class TDoubleCharHash extends TPrimitiveHash
{
    ...
    public TDoubleCharHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0;
        this.no_entry_value = '\0';
    }
    
    public TDoubleCharHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0;
        this.no_entry_value = '\0';
    }
    
    public TDoubleCharHash(final int initialCapacity, final float loadFactor, final double no_entry_key, final char no_entry_value) {
        super(initialCapacity, loadFactor);
