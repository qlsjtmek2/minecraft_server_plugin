...
public abstract class TCharLongHash extends TPrimitiveHash
{
    ...
    public TCharLongHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = '\0';
        this.no_entry_value = 0L;
    }
    
    public TCharLongHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = '\0';
        this.no_entry_value = 0L;
    }
    
    public TCharLongHash(final int initialCapacity, final float loadFactor, final char no_entry_key, final long no_entry_value) {
        super(initialCapacity, loadFactor);
