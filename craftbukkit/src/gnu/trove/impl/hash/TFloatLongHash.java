...
public abstract class TFloatLongHash extends TPrimitiveHash
{
    ...
    public TFloatLongHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0f;
        this.no_entry_value = 0L;
    }
    
    public TFloatLongHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0f;
        this.no_entry_value = 0L;
    }
    
    public TFloatLongHash(final int initialCapacity, final float loadFactor, final float no_entry_key, final long no_entry_value) {
        super(initialCapacity, loadFactor);
