...
public abstract class TFloatByteHash extends TPrimitiveHash
{
    ...
    public TFloatByteHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0f;
        this.no_entry_value = 0;
    }
    
    public TFloatByteHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0f;
        this.no_entry_value = 0;
    }
    
    public TFloatByteHash(final int initialCapacity, final float loadFactor, final float no_entry_key, final byte no_entry_value) {
        super(initialCapacity, loadFactor);
