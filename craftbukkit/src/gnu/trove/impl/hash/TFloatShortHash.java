...
public abstract class TFloatShortHash extends TPrimitiveHash
{
    ...
    public TFloatShortHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0f;
        this.no_entry_value = 0;
    }
    
    public TFloatShortHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0f;
        this.no_entry_value = 0;
    }
    
    public TFloatShortHash(final int initialCapacity, final float loadFactor, final float no_entry_key, final short no_entry_value) {
        super(initialCapacity, loadFactor);
