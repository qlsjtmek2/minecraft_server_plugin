...
public abstract class TDoubleByteHash extends TPrimitiveHash
{
    ...
    public TDoubleByteHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0;
        this.no_entry_value = 0;
    }
    
    public TDoubleByteHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0;
        this.no_entry_value = 0;
    }
    
    public TDoubleByteHash(final int initialCapacity, final float loadFactor, final double no_entry_key, final byte no_entry_value) {
        super(initialCapacity, loadFactor);
