...
public abstract class TByteCharHash extends TPrimitiveHash
{
    ...
    public TByteCharHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = '\0';
    }
    
    public TByteCharHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = '\0';
    }
    
    public TByteCharHash(final int initialCapacity, final float loadFactor, final byte no_entry_key, final char no_entry_value) {
        super(initialCapacity, loadFactor);
