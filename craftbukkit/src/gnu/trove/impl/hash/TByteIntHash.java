...
public abstract class TByteIntHash extends TPrimitiveHash
{
    ...
    public TByteIntHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TByteIntHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TByteIntHash(final int initialCapacity, final float loadFactor, final byte no_entry_key, final int no_entry_value) {
        super(initialCapacity, loadFactor);
