...
public abstract class TIntShortHash extends TPrimitiveHash
{
    ...
    public TIntShortHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TIntShortHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TIntShortHash(final int initialCapacity, final float loadFactor, final int no_entry_key, final short no_entry_value) {
        super(initialCapacity, loadFactor);
