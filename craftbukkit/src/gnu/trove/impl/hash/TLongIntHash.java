...
public abstract class TLongIntHash extends TPrimitiveHash
{
    ...
    public TLongIntHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0L;
        this.no_entry_value = 0;
    }
    
    public TLongIntHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0L;
        this.no_entry_value = 0;
    }
    
    public TLongIntHash(final int initialCapacity, final float loadFactor, final long no_entry_key, final int no_entry_value) {
        super(initialCapacity, loadFactor);
