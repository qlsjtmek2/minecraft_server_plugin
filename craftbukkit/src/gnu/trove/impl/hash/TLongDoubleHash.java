...
public abstract class TLongDoubleHash extends TPrimitiveHash
{
    ...
    public TLongDoubleHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0L;
        this.no_entry_value = 0.0;
    }
    
    public TLongDoubleHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0L;
        this.no_entry_value = 0.0;
    }
    
    public TLongDoubleHash(final int initialCapacity, final float loadFactor, final long no_entry_key, final double no_entry_value) {
        super(initialCapacity, loadFactor);
