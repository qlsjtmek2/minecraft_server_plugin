...
public abstract class TFloatIntHash extends TPrimitiveHash
{
    ...
    public TFloatIntHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0f;
        this.no_entry_value = 0;
    }
    
    public TFloatIntHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0f;
        this.no_entry_value = 0;
    }
    
    public TFloatIntHash(final int initialCapacity, final float loadFactor, final float no_entry_key, final int no_entry_value) {
        super(initialCapacity, loadFactor);
