...
public abstract class TLongCharHash extends TPrimitiveHash
{
    ...
    public TLongCharHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0L;
        this.no_entry_value = '\0';
    }
    
    public TLongCharHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0L;
        this.no_entry_value = '\0';
    }
    
    public TLongCharHash(final int initialCapacity, final float loadFactor, final long no_entry_key, final char no_entry_value) {
        super(initialCapacity, loadFactor);
