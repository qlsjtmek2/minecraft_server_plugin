...
public abstract class TShortLongHash extends TPrimitiveHash
{
    ...
    public TShortLongHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = 0L;
    }
    
    public TShortLongHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = 0L;
    }
    
    public TShortLongHash(final int initialCapacity, final float loadFactor, final short no_entry_key, final long no_entry_value) {
        super(initialCapacity, loadFactor);
