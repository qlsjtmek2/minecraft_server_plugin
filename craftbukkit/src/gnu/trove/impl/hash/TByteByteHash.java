...
public abstract class TByteByteHash extends TPrimitiveHash
{
    ...
    public TByteByteHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TByteByteHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = 0;
    }
    
    public TByteByteHash(final int initialCapacity, final float loadFactor, final byte no_entry_key, final byte no_entry_value) {
        super(initialCapacity, loadFactor);
