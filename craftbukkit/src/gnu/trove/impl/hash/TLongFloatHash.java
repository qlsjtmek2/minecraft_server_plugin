...
public abstract class TLongFloatHash extends TPrimitiveHash
{
    ...
    public TLongFloatHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0L;
        this.no_entry_value = 0.0f;
    }
    
    public TLongFloatHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0L;
        this.no_entry_value = 0.0f;
    }
    
    public TLongFloatHash(final int initialCapacity, final float loadFactor, final long no_entry_key, final float no_entry_value) {
        super(initialCapacity, loadFactor);
