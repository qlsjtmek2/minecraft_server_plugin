...
public abstract class TDoubleLongHash extends TPrimitiveHash
{
    ...
    public TDoubleLongHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0;
        this.no_entry_value = 0L;
    }
    
    public TDoubleLongHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0;
        this.no_entry_value = 0L;
    }
    
    public TDoubleLongHash(final int initialCapacity, final float loadFactor, final double no_entry_key, final long no_entry_value) {
        super(initialCapacity, loadFactor);
