...
public abstract class TDoubleShortHash extends TPrimitiveHash
{
    ...
    public TDoubleShortHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0.0;
        this.no_entry_value = 0;
    }
    
    public TDoubleShortHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0.0;
        this.no_entry_value = 0;
    }
    
    public TDoubleShortHash(final int initialCapacity, final float loadFactor, final double no_entry_key, final short no_entry_value) {
        super(initialCapacity, loadFactor);
