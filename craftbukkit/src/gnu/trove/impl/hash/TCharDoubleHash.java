...
public abstract class TCharDoubleHash extends TPrimitiveHash
{
    ...
    public TCharDoubleHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = '\0';
        this.no_entry_value = 0.0;
    }
    
    public TCharDoubleHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = '\0';
        this.no_entry_value = 0.0;
    }
    
    public TCharDoubleHash(final int initialCapacity, final float loadFactor, final char no_entry_key, final double no_entry_value) {
        super(initialCapacity, loadFactor);
    ...
    protected int index(final char key) {
        final byte[] states = this._states;
        final char[] set = this._set;
    ...
    protected int XinsertKey(final char key) {
        final byte[] states = this._states;
        final char[] set = this._set;
        final int length = states.length;
        final int hash = HashFunctions.hash(key) & Integer.MAX_VALUE;
