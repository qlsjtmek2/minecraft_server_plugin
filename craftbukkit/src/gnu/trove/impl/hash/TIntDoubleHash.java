...
public abstract class TIntDoubleHash extends TPrimitiveHash
{
    ...
    public TIntDoubleHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = 0.0;
    }
    
    public TIntDoubleHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = 0.0;
    }
    
    public TIntDoubleHash(final int initialCapacity, final float loadFactor, final int no_entry_key, final double no_entry_value) {
        super(initialCapacity, loadFactor);
