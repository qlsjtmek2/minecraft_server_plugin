...
public abstract class TByteFloatHash extends TPrimitiveHash
{
    ...
    public TByteFloatHash(final int initialCapacity) {
        super(initialCapacity);
        this.no_entry_key = 0;
        this.no_entry_value = 0.0f;
    }
    
    public TByteFloatHash(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
        this.no_entry_key = 0;
        this.no_entry_value = 0.0f;
    }
    
    public TByteFloatHash(final int initialCapacity, final float loadFactor, final byte no_entry_key, final float no_entry_value) {
        super(initialCapacity, loadFactor);
