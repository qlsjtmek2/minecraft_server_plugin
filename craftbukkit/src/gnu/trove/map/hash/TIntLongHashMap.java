...
public class TIntLongHashMap extends TIntLongHash implements TIntLongMap, Externalizable
{
    ...
    public TIntLongHashMap(final int initialCapacity, final float loadFactor, final int noEntryKey, final long noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }
    
    public TIntLongHashMap(final int[] keys, final long[] values) {
    ...
    public TIntLongHashMap(final TIntLongMap map) {
        super(map.size());
    ...
    public void putAll(final Map<? extends Integer, ? extends Long> map) {
        ...
        for (final Map.Entry<? extends Integer, ? extends Long> entry : map.entrySet()) {
            this.put((int)entry.getKey(), (long)entry.getValue());
        }
    }
    
    public void putAll(final TIntLongMap map) {
        this.ensureCapacity(map.size());
    ...
    {
        TIntLongKeyHashIterator(final TPrimitiveHash hash) {
            super(hash);
        }
    ...
    {
        TIntLongValueHashIterator(final TPrimitiveHash hash) {
            super(hash);
        }
    ...
    {
        TIntLongHashIterator(final TIntLongHashMap map) {
            super(map);
        }
