...
public class TDoubleIntHashMap extends TDoubleIntHash implements TDoubleIntMap, Externalizable
{
    ...
    public TDoubleIntHashMap(final int initialCapacity) {
        super(initialCapacity);
    }
    
    public TDoubleIntHashMap(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
    }
    
    public TDoubleIntHashMap(final int initialCapacity, final float loadFactor, final double noEntryKey, final int noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }
    
    public TDoubleIntHashMap(final double[] keys, final int[] values) {
    ...
    public TDoubleIntHashMap(final TDoubleIntMap map) {
        super(map.size());
        if (map instanceof TDoubleIntHashMap) {
            final TDoubleIntHashMap hashmap = (TDoubleIntHashMap)map;
    ...
    private int doPut(final double key, final int value, int index) {
    ...
    public void putAll(final Map<? extends Double, ? extends Integer> map) {
        ...
        for (final Map.Entry<? extends Double, ? extends Integer> entry : map.entrySet()) {
            this.put((double)entry.getKey(), (int)entry.getValue());
        }
    }
    
    public void putAll(final TDoubleIntMap map) {
        this.ensureCapacity(map.size());
        final TDoubleIntIterator iter = map.iterator();
        while (iter.hasNext()) {
            iter.advance();
    ...
    public boolean equals(final Object other) {
        ...
        final TDoubleIntMap that = (TDoubleIntMap)other;
    ...
    public String toString() {
        ...
        this.forEachEntry(new TDoubleIntProcedure() {
            ...
            public boolean execute(final double key, final int value) {
                if (this.first) {
                    this.first = false;
                }
                else {
    ...
    protected class TKeyView implements TDoubleSet
    {
        ...
        public boolean retainAll(final double[] array) {
            ...
            Arrays.sort(array);
            final double[] set = TDoubleIntHashMap.this._set;
            final byte[] states = TDoubleIntHashMap.this._states;
            int i = set.length;
            while (i-- > 0) {
    ...
    protected class TValueView implements TIntCollection
    {
        ...
        public boolean remove(final int entry) {
            final int[] values = TDoubleIntHashMap.this._values;
            final double[] set = TDoubleIntHashMap.this._set;
            int i = values.length;
            while (i-- > 0) {
    ...
    {
        TDoubleIntKeyHashIterator(final TPrimitiveHash hash) {
            super(hash);
        }
    ...
    {
        TDoubleIntValueHashIterator(final TPrimitiveHash hash) {
            super(hash);
        }
    ...
    {
        TDoubleIntHashIterator(final TDoubleIntHashMap map) {
            super(map);
        }
