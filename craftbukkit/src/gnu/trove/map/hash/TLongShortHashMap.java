...
public class TLongShortHashMap extends TLongShortHash implements TLongShortMap, Externalizable
{
    ...
    public TLongShortHashMap(final int initialCapacity, final float loadFactor, final long noEntryKey, final short noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }
    
    public TLongShortHashMap(final long[] keys, final short[] values) {
    ...
    public TLongShortHashMap(final TLongShortMap map) {
        super(map.size());
        if (map instanceof TLongShortHashMap) {
            final TLongShortHashMap hashmap = (TLongShortHashMap)map;
    ...
    public void putAll(final Map<? extends Long, ? extends Short> map) {
        ...
        for (final Map.Entry<? extends Long, ? extends Short> entry : map.entrySet()) {
            this.put((long)entry.getKey(), (short)entry.getValue());
        }
    }
    
    public void putAll(final TLongShortMap map) {
        this.ensureCapacity(map.size());
        final TLongShortIterator iter = map.iterator();
        while (iter.hasNext()) {
            iter.advance();
    ...
    public boolean equals(final Object other) {
        ...
        final TLongShortMap that = (TLongShortMap)other;
    ...
    protected class TKeyView implements TLongSet
    {
        ...
        public boolean retainAll(final long[] array) {
            ...
            Arrays.sort(array);
            final long[] set = TLongShortHashMap.this._set;
            final byte[] states = TLongShortHashMap.this._states;
            int i = set.length;
            while (i-- > 0) {
    ...
    protected class TValueView implements TShortCollection
    {
        ...
        public boolean remove(final short entry) {
            final short[] values = TLongShortHashMap.this._values;
            final long[] set = TLongShortHashMap.this._set;
            int i = values.length;
            while (i-- > 0) {
    ...
    {
        TLongShortKeyHashIterator(final TPrimitiveHash hash) {
            super(hash);
        }
    ...
    {
        TLongShortValueHashIterator(final TPrimitiveHash hash) {
            super(hash);
        }
    ...
    {
        TLongShortHashIterator(final TLongShortHashMap map) {
            super(map);
        }
