...
public class TDoubleByteHashMap extends TDoubleByteHash implements TDoubleByteMap, Externalizable
{
    ...
    public TDoubleByteHashMap(final int initialCapacity) {
        super(initialCapacity);
    }
    
    public TDoubleByteHashMap(final int initialCapacity, final float loadFactor) {
        super(initialCapacity, loadFactor);
    }
    
    public TDoubleByteHashMap(final int initialCapacity, final float loadFactor, final double noEntryKey, final byte noEntryValue) {
        super(initialCapacity, loadFactor, noEntryKey, noEntryValue);
    }
    
    public TDoubleByteHashMap(final double[] keys, final byte[] values) {
    ...
    public TDoubleByteHashMap(final TDoubleByteMap map) {
        super(map.size());
        if (map instanceof TDoubleByteHashMap) {
            final TDoubleByteHashMap hashmap = (TDoubleByteHashMap)map;
    ...
    private byte doPut(final double key, final byte value, int index) {
    ...
    public void putAll(final Map<? extends Double, ? extends Byte> map) {
        ...
        for (final Map.Entry<? extends Double, ? extends Byte> entry : map.entrySet()) {
            this.put((double)entry.getKey(), (byte)entry.getValue());
        }
    }
    
    public void putAll(final TDoubleByteMap map) {
        this.ensureCapacity(map.size());
        final TDoubleByteIterator iter = map.iterator();
        while (iter.hasNext()) {
            iter.advance();
    ...
    public boolean equals(final Object other) {
        ...
        final TDoubleByteMap that = (TDoubleByteMap)other;
    ...
    public String toString() {
        ...
        this.forEachEntry(new TDoubleByteProcedure() {
            ...
            public boolean execute(final double key, final byte value) {
                if (this.first) {
                    this.first = false;
                }
                else {
    ...
    protected class TKeyView implements TDoubleSet
    {
        ...
        public boolean retainAll(final double[] array) {
            ...
            Arrays.sort(array);
            final double[] set = TDoubleByteHashMap.this._set;
            final byte[] states = TDoubleByteHashMap.this._states;
            int i = set.length;
            while (i-- > 0) {
    ...
    protected class TValueView implements TByteCollection
    {
        ...
        public boolean remove(final byte entry) {
            final byte[] values = TDoubleByteHashMap.this._values;
            final double[] set = TDoubleByteHashMap.this._set;
            int i = values.length;
            while (i-- > 0) {
    ...
    {
        TDoubleByteKeyHashIterator(final TPrimitiveHash hash) {
            super(hash);
        }
    ...
    {
        TDoubleByteValueHashIterator(final TPrimitiveHash hash) {
            super(hash);
        }
    ...
    {
        TDoubleByteHashIterator(final TDoubleByteHashMap map) {
            super(map);
        }
