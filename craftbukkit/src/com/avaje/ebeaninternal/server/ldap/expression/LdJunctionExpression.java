...
abstract class LdJunctionExpression<T> implements Junction<T>, SpiExpression
{
    ...
    LdJunctionExpression(final String joinType, final Query<T> query, final ExpressionList<T> parent) {
        this.joinType = joinType;
        this.exprList = new DefaultExpressionList<T>(query, parent);
    }
    
    LdJunctionExpression(final String joinType, final ExpressionFactory exprFactory) {
        this.joinType = joinType;
    ...
    static class Conjunction<T> extends LdJunctionExpression<T>
    {
        ...
        Conjunction(final ExpressionFactory exprFactory) {
            super("&", exprFactory);
        }
    }
    ...
    static class Disjunction<T> extends LdJunctionExpression<T>
    {
        ...
        Disjunction(final ExpressionFactory exprFactory) {
            super("|", exprFactory);
        }
    }
}
