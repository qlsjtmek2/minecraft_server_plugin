...
public final class InetAddresses
{
    ...
    private static Inet4Address getInet4Address(final byte[] bytes) {
        ...
        try {
            final InetAddress ipv4 = InetAddress.getByAddress(bytes);
    ...
    public static InetAddress forUriString(final String hostAddr) {
        ...
        Preconditions.checkArgument(hostAddr.length() > 0, (Object)"host string is empty");
    ...
    public static TeredoInfo getTeredoInfo(final Inet6Address ip) {
        ...
        final byte[] bytes = ip.getAddress();
        final Inet4Address server = getInet4Address(copyOfRange(bytes, 4, 8));
        ...
        final byte[] clientBytes = copyOfRange(bytes, 12, 16);
    ...
    public static InetAddress increment(final InetAddress address) {
        ...
        Preconditions.checkArgument(i >= 0, (Object)("Incrementing " + address + " would wrap."));
    ...
    private static byte[] copyOfRange(final byte[] original, final int from, final int to) {
        ...
        final int end = Math.min(to, original.length);
