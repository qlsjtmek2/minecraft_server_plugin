...
public final class Constraints
{
    ...
    public static <E> Multiset<E> constrainedMultiset(final Multiset<E> multiset, final Constraint<? super E> constraint) {
    ...
    static class ConstrainedMultiset<E> extends ForwardingMultiset<E>
    {
        ...
        public ConstrainedMultiset(final Multiset<E> delegate, final Constraint<? super E> constraint) {
            this.delegate = Preconditions.checkNotNull(delegate);
            this.constraint = Preconditions.checkNotNull(constraint);
        }
