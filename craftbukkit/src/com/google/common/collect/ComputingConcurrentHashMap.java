...
class ComputingConcurrentHashMap<K, V> extends CustomConcurrentHashMap<K, V>
{
    ...
    {
        ComputingSegment(final CustomConcurrentHashMap<K, V> map, final int initialCapacity, final int maxSegmentSize) {
    ...
    static final class ComputingMapAdapter<K, V> extends ComputingConcurrentHashMap<K, V> implements Serializable
    {
        ...
        ComputingMapAdapter(final MapMaker mapMaker, final Function<? super K, ? extends V> computingFunction) {
            super(mapMaker, (Function<? super Object, ?>)computingFunction);
        }
