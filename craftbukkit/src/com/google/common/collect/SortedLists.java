...
final class SortedLists
{
    ...
    public static <E, K> int binarySearch(final List<E> list, final Function<? super E, K> keyFunction, final K key, final Comparator<? super K> keyComparator, final KeyPresentBehavior presentBehavior, final KeyAbsentBehavior absentBehavior) {
    ...
    {
        NEXT_LOWER {
             <E> int resultIndex(final int higherIndex) {
                return higherIndex - 1;
            }
        }, 
        NEXT_HIGHER {
            public <E> int resultIndex(final int higherIndex) {
                return higherIndex;
            }
        }, 
        ...
        abstract <E> int resultIndex(final int p0);
    }
}
