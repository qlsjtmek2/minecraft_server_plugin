...
public class UnsafeList<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, Serializable
{
    ...
    public void trimToSize() {
        ...
        if (rounded < old) {
            this.data = Java15Compat.Arrays_copyOf(this.data, rounded);
        }
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        copy.data = Java15Compat.Arrays_copyOf(this.data, this.size);
        copy.size = this.size;
    ...
    public Iterator<E> iterator() {
        for (final Iterator iter : this.iterPool) {
            if (!((Itr)iter).valid) {
    ...
    public class Itr implements Iterator<E>
    {
        ...
        public E next() {
            ...
            this.index = i + 1;
            final Object[] access$400 = UnsafeList.this.data;
            final int lastRet = i;
            this.lastRet = lastRet;
            return (E)access$400[lastRet];
        }
