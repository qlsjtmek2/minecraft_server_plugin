...
public class ClassFileCompiler extends Compiler implements CGConst
{
    ...
    private void __go() throws Exn, IOException {
        ...
        addMethod.add((byte)(-69), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
        ...
        addMethod.add((byte)(-73), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException").method("<init>", Type.VOID, new Type[] { Type.STRING }));
        ...
        final Type.Class instance4 = Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$CPUState");
        ...
        addMethod5.add((byte)(-69), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$FaultException"));
        addMethod5.add((byte)89);
        addMethod5.add((byte)43);
        addMethod5.add((byte)(-73), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$FaultException").method("<init>", Type.VOID, new Type[] { Type.Class.instance("java.lang.RuntimeException") }));
        addMethod5.add((byte)(-65));
        addMethod5.addExceptionHandler(size2, size3, size4, Type.Class.instance("java.lang.RuntimeException"));
        addMethod5.addThrow(Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
        ...
        if (this.unixRuntime) {
            final Type.Class instance5 = Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.UnixRuntime");
    ...
    private void emitData(int i, final DataInputStream dataInputStream, int n, final boolean b) throws Exn, IOException {
        ...
        while (i < i + n) {
            ...
            this.clinit.add((byte)(-72), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime").method("decodeData", (Type)Type.INT.makeArray(), new Type[] { Type.STRING, Type.INT }));
    ...
    private void endMethod(final int n, final boolean b) {
        ...
        if (this.debugCompiler) {
            this.mg.add((byte)(-69), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
            this.mg.add((byte)89);
            ...
            this.mg.add((byte)(-73), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException").method("<init>", Type.VOID, new Type[] { Type.STRING }));
            this.mg.add((byte)(-65));
        }
        else {
            this.mg.add((byte)(-69), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
            ...
            switch (n5) {
                case 0: {
                    switch (n13) {
                        ...
                        case 13: {
                            mg.add((byte)(-69), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
                            mg.add((byte)89);
                            mg.add((byte)18, (Object)("BREAK Code " + Compiler.toHex(n14)));
                            mg.add((byte)(-73), (Object)Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException").method("<init>", Type.VOID, new Type[] { Type.STRING }));
                            mg.add((byte)(-65));
                            n4 |= 0x1;
                            break Label_7720;
                        }
