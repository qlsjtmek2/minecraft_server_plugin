...
public final class MapTypeAdapterFactory implements TypeAdapterFactory
{
    ...
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
        ...
        final ObjectConstructor<T> constructor = this.constructorConstructor.getConstructor(typeToken);
    ...
    private static <T> JsonElement toJsonTree(final TypeAdapter<T> typeAdapter, final T value) {
        try {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>>
    {
        ...
        public void write(final JsonWriter out, final Map<K, V> map) throws IOException {
            ...
            for (final Map.Entry<K, V> entry2 : map.entrySet()) {
                final JsonElement keyElement = toJsonTree(this.keyTypeAdapter, entry2.getKey());
                keys.add(keyElement);
