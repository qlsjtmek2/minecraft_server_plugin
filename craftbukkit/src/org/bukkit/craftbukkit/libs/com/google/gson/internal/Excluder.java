...
import org.bukkit.craftbukkit.libs.com.google.gson.annotations.Until;
    ...
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> type) {
        ...
        return new TypeAdapter<T>() {
            ...
            private TypeAdapter<T> delegate() {
                ...
                return (d != null) ? d : (this.delegate = GsonInternalAccess.INSTANCE.getNextAdapter(gson, Excluder.this, type));
            }
        };
    }
