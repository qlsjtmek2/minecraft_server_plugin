...
public interface ConfigurationSection
{
    ...
    Vector getVector(final String p0);
    
    Vector getVector(final String p0, final Vector p1);
    
    boolean isVector(final String p0);
    
    OfflinePlayer getOfflinePlayer(final String p0);
    
    OfflinePlayer getOfflinePlayer(final String p0, final OfflinePlayer p1);
    
    boolean isOfflinePlayer(final String p0);
    
    ItemStack getItemStack(final String p0);
    
    ItemStack getItemStack(final String p0, final ItemStack p1);
    
    boolean isItemStack(final String p0);
    
    Color getColor(final String p0);
    
    Color getColor(final String p0, final Color p1);
    
    boolean isColor(final String p0);
