...
final class NativeDB extends DB
{
    ...
    protected synchronized native int _exec(final String p0) throws SQLException;
    ...
    synchronized native int backup(final String p0, final String p1, final ProgressObserver p2) throws SQLException;
    
    synchronized native int restore(final String p0, final String p1, final ProgressObserver p2) throws SQLException;
